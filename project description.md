...
*   **Detailed Timelines:** Click on any issue card to open a comprehensive modal featuring a "Work Progress Report" timeline, tracking the issue from "Reported" to "Resolution Verified".
*   **Community Interaction:** Upvote pressing issues and engage in comment threads directly under the issue details.

### 🤝 Community Teams & Real-Time Chat
*   **Join & Create Teams:** Easily discover active groups in your area (like the *Green Andheri Drive* or *Clean Streets Brigade*) and join them with a single click, or create your own team with a custom focus area.
*   **Fully Functional Team Chat:** Engage with your team in a sleek, animated chat interface. 
*   **Express Agreement:** Hover over messages to quickly **"Like to Agree" (👍)**, instantly updating a live counter badge.
*   **Moderation:** Flag and report inappropriate messages to keep the community safe.
